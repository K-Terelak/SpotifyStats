...
class AuthRepositoryImpl(
    ...
    override suspend fun getAuthToken(code: String): SimpleResource = try {
    ...
    override suspend fun getRefreshAuthToken(): SimpleResource = try {

        val refreshToken = sharedPreferences.getString(KEY_REFRESH_BEARER_TOKEN, "") ?: ""
        if (refreshToken.isEmpty())
            Resource.Error<SimpleResource>(R.string.not_logged_in)
    ...
    override suspend fun logout(): SimpleResource = try {
